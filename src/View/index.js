...
import {Button, Grid, CardActionArea} from "@mui/material";
    ...
    return (
        <div>
            ...
            <Grid Style={{alignItem: 'center'}} container spacing={1}>
                <Grid item xs={12}>
                    <div style={{textAlign: 'center'}}>
                        <h2 style={{letterSpacing: '5px', color: '#ff0000'}}>TEACHERS</h2>
                        <h1 style={{color: '#44425A'}}>Meet Our Teachers</h1>
                    </div>
                </Grid>
                <Grid container spacing={1}>
                    <Grid item xs={12} sm={4}>
                        <Card sx={{maxWidth: 345}}>
                            <CardActionArea>
                                <CardMedia
                                    component="img"
                                    height="300"
                                    image="http://www.seoulhotelsrilanka.com/img/team-1.jpg"
                                    alt="green iguana"
                                />
                                <CardContent>
                        ...
                        <Card sx={{maxWidth: 345}}>
                            <CardActionArea>
                                <CardMedia
                                    component="img"
                                    height="300"
                                    image="http://www.seoulhotelsrilanka.com/img/team-2.jpg"
                                    alt="green iguana"
                                />
                                <CardContent>
                                    <Typography gutterBottom variant="h5" component="div">
                        ...
                        <Card sx={{maxWidth: 345}}>
                            <CardActionArea>
                                <CardMedia
                                    component="img"
                                    height="300"
                                    image="http://www.seoulhotelsrilanka.com/img/team-3.jpg"
                                    alt="green iguana"
                                />
                                <CardContent>
                                    <Typography gutterBottom variant="h5" component="div">
            ...
            <Grid container
                ...
                <Grid item xs={12}>
                    <div style={{textAlign: 'center'}}>
                        <h2 style={{letterSpacing: '5px', color: '#ff0000'}}>OUR BLOG</h2>
                        <h1 style={{color: '#44425A'}}>Latest From Our Blog</h1>
                    </div>
                </Grid>
                <Grid container
                      direction="row"
                    ...
                    <Grid item xs={12} sm={4}>
                        <Card sx={{maxWidth: 345}}>
                            <CardActionArea style={{
                                backgroundImage:
                                    "url('http://www.seoulhotelsrilanka.com/img/about.jpg')",
                            ...
                            />*/}
                                <CardContent style={{textAlign: 'left'}}>
                                    <Typography style={{color: '#fff'}} gutterBottom variant="h5" component="div">
                                        Lorem elitr magna stet eirmod labore amet labore
                                        clita
                                        at ut clita
                                    </Typography>
                                    <Typography style={{color: '#ff0000'}} variant="body2" color="text.secondary">
                                        Jan 01, 2050 </Typography>
                                </CardContent>
                            </CardActionArea>
                        </Card>
                    </Grid>
